  ...
  return (
    <div className='bg-green-200 flex flex-col h-full w-full justify-start items-center mt-10'>
        <div className='flex w-full h-1/2 gap-4'>
            {step2Selections.map((selection) => <SelectInput key={selection.key} avatar={selection.avatar} title={selection.title} price={isMonthly ? selection.monthlyPrice : selection.yearlyPrice} isMonthly={isMonthly} />)}
        </div>
